// Type definitions for Rebass 2.0.2
// Source: https://github.com/jxnblk/rebass
import * as React from 'react';

// Additional type definitions not provided in current @types/rebass library:
// --------------------------------------------------------------------------
export { ThemeProvider as Provider } from 'styled-components';
export { Box, Flex } from 'grid-styled';

type NavLinkClass = React.StatelessComponent<any>;
export declare const NavLink: NavLinkClass;

export declare const ButtonTransparent: any;
...
// Type definitions provided by @types/rebass:
export interface BaseProps<C> extends React.DOMAttributes<C> {
  tagName?: string;
  className?: string;
  baseStyle?: Object;
  style?: Object;
...
export declare const Panel: PanelClass & { Header: any; Footer: any };
